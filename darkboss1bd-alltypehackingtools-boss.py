...
##   HACKINGTOOLS 	:   CyberSecurity Resources & Tools
##   Author      	: 	DARKBOSS1BD (aK47)
##   Version     	: 	3.0
...
######  #     # #     # #    # ######  #######  #####   #####   ##### ######  ######  
 ...
 \033[37m[X]𝗔𝗹𝗹 𝗜𝗻 𝗢𝗻𝗲 𝗧𝗼𝗼𝗹𝘀 𝗙𝗼𝗿 𝗖𝘆𝗯𝗲𝗿𝘀𝗲𝗰𝘂𝗿𝗶𝘁𝘆 𝗨𝗽𝗱𝗮𝘁𝗲𝗱 𝗯𝘆 𝗖𝗼𝗱𝗶𝗻𝗴 darkboss1bd 𝗔𝘁 Ak47[X]
        \033[35m [✔] 𝗩𝗲𝗿𝘀𝗶𝗼𝗻 3.𝟬 [✔]\033[32m[✔]- 𝗕𝗲𝗴𝗶𝗻𝗻𝗲𝗿 𝗙𝗿𝗶𝗲𝗻𝗱𝗹𝘆 -[✔]
...
if __name__ == "__main__":
    try:
        if system() == 'Linux':
            fpath = "/home/darkboss1bd-alltypehackingtools-boss.txt"
